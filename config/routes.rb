Rails.application.routes.draw do
  ...
  get '/Peterburg',            to: redirect(URI.encode('/delivery_pages/5-Доставка%20воды%20в%20Санкт-Петербурге'), status: 301)
  get '/voda-v-ofis',          to: redirect(URI.encode('/delivery_pages/2-Доставка%20воды%20в%20офис'), status: 301)
  ...
  get '/voda-na-dom',          to: redirect(URI.encode('/delivery_pages/1-Доставка%20воды%20на%20дом'), status: 301)
  ...
  get '/schools',              to: redirect(URI.encode('/delivery_pages/3-Доставка%20воды%20в%20школы%20и%20детские%20сады'), status: 301)
